...
export const projectsArray = [
    ...
    { 
      ...
      features: ["advanced SEO optimization", "structured data for SEO", "open graph meta data", "monetization with Google AdSense", "shop functionality with Stripe", "asset storage with Firebase Storage", "form submission", "automated email alerts", "responsive design"],
      technologies: ["Next.js", "React", "Node.js", "Tailwind", "Route Handlers (API Routes)", "Stripe API", "Firebase Storage", "Controlled Forms", "Nodemailer"],
      techIconsArray: ["/images/skills/next.png", "/images/skills/react.png", "/images/skills/node.png", "/images/skills/tailwind.png", "/images/skills/stripe.png", "/images/skills/firebase.png"],
      shortDescription: "Multi-featured website for a local business",
      longDescription: "A website / web app for a local music school business. Includes multiple pages describing the services offered by the business. Shop page contains complex cart functionality that uses Context API for state management and Stripe API for payments. Blog articles show Google AdSense ads and are monetized. Website has 3 separate controlled forms (trial lesson, registration and application) that visitors can submit, with automatic email alerts going to the admin. Service-related pages have been optimized for SEO, with most pages ranking in the top 5 on Google in local search results.",
    ...
    { 
      ...
      features: ["mailchimp integration", "form submission", "automated email alerts", "responsive design"],
      technologies: ["Next.js", "React", "Node.js", "Tailwind", "Nodemailer", "Mailchimp API"],
      ...
      shortDescription: "A website for a real estate agent",
      longDescription: "A personal website for a real estate client/business. Client continues to add new content on a regular basis. Biggest features so far have been Mailchimp integration via Mailchimp API, allowing visitors to input their email address right on the home page in order to join the agent's mailing list. The API will respond to 1. successful subscription 2. a message where given email is already subscribed 3. any error joining the mailing list. Website also contains contact form where any submissions will send an automated email alert to client via Nodemailer. Have also done multiple landing pages for the client for various promotions/events. More features to come.",
