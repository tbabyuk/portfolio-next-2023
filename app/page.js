  ...
  return (
    <main>
      ...
      <section className="about-section relative pt-32 pb-44 flex flex-col justify-center bg-gray-50" id="about">
        <a href="/terry_web_dev_sm_2023.pdf" className="absolute flex items-center top-2 right-8 py-3 px-4 bg-[#f09c6c] hover:bg-[#ec8346] rounded text-gray-50" download><BiSolidFilePdf />&nbsp;RESUME</a>
