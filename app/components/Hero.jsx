...
export const Hero = () => {
  ...
  return (
        <header className="h-[calc(100vh-50px)] pt-20 pb-12 relative bg-blue-800 bg-center bg-cover">
            <div></div>
            <div></div>
        </header>
    )
...
//OLD VERSION
{/* <header className="h-[calc(100vh-50px)] pt-20 pb-12 relative bg-[url('/images/header_bg.jpg')] bg-center bg-cover">
