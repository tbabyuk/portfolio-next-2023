...
export const AboutSection = () => {
  ...
  return (
        <section className="relative home-section-padding flex flex-col justify-center bg-[url('/images/bg_light.jpg')] bg-center bg-cover">
            <a href="/terry_web_dev_2024_new_sm.pdf" className="absolute flex items-center bottom-14 right-14 py-3 px-4 bg-[#f09c6c] hover:bg-[#ec8346] rounded text-gray-50" download><BiSolidFilePdf />&nbsp;RESUME</a>
