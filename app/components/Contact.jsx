...
export const Contact = () => {
    return (
        <section className="about-section py-28 flex flex-col justify-center bg-[url('/images/contact_bg.jpg')]" id="contact">
              ...
              <div className="flex justify-center px-5 lg:px-20 xl:px-48">
